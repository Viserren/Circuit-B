...
namespace BrainFailProductions.PolyFew
{
    public class EditorCoroutines
	{
		...
		System.DateTime previousTimeSinceStartup;
		...
		void Initialize()
		{
			previousTimeSinceStartup = System.DateTime.Now;
		...
		void OnUpdate()
		{
			float deltaTime = (float) (System.DateTime.Now.Subtract(previousTimeSinceStartup).TotalMilliseconds / 1000.0f);
